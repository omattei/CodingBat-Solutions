...
public String comboString(String a, String b) {
  // H_0: a is shorter string, b is longer string.
  String shorter = b;
  String longer = a;
  
  // H_a: b is shorter string, a is longer string.
...
public String twoChar(String str, int index) {
  ...
  if (index > str.length() - 2 || index < 0) {
    reply = str.substring(0, 2);
  } else {
    reply = str.substring(index, index + 2);
  }
...
public boolean hasBad(String str) {
  return (str.length() <= 3) ? str.equals("bad") : str.substring(0, 4).contains("bad");
}
...
public String lastChars(String a, String b) {
  String first = a.equals("") ? "@" : "" + a.charAt(0);
  String last = b.equals("") ? "@" :  "" + b.charAt(b.length() - 1);
  return first + last;
}
...
public String conCat(String a, String b) {
  ...
  if (!a.equals("") && !b.equals("") && a.charAt(a.length() - 1) == b.charAt(0)) 
    reply = a + b.substring(1);
...
public String lastTwo(String str) {
  ...
  if (str.length() > 1)
    reply = str.substring(0, str.length() - 2) + str.charAt(str.length() - 1) + str.charAt(str.length() - 2);
...
public String seeColor(String str) {
  ...
  for (String color : colors){
    if (str.length() >= color.length() && 
        str.substring(0,color.length()).contains(color)) {
      return color;    
    }
  } return "";   
}
...
public boolean frontAgain(String str) {
  return str.length() < 2 ? false : str.substring(str.length() - 2).equals(str.substring(0,2));  
}
...
public String extraFront(String str) {
  int index = str.length() > 1 ? 2 : str.length();
...
public String deFront(String str) {    
  ...
  boolean firstCk = str.charAt(0) == 'a';
  boolean secondCk = str.charAt(1) == 'b';
  ...
  if (firstCk && secondCk)
    ...
    reply = str.charAt(0) + str.substring(2);
  else if (secondCk)
    reply = str.substring(1);
  else 
    reply = str.substring(2);
...
public String startWord(String str, String word) {
  ...
  word = "" + str.charAt(0) + (word.length() > 1 ? word.substring(1) : "");
  
  return str.substring(0, word.length()).equals(word) ? word : "";
}
